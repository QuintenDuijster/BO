            ...
            <main className="Faq">
                ...
                <div className="Tickets">
                    <details>
                        ...
                        <div className="Info">
                            <details>
                                <summary  >Kan ik een ticket aan de deur kopen?</summary>
                            ...
                            <details>
                                <summary  >Hoe kan ik mijn tijdslot wijzigen?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Kan ik mijn ticket retourneren?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Kan ik een factuur krijgen voor mijn ticket(s)?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Ik heb teveel tickets besteld, kan ik een terugbetaling aanvragen?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Ik ben een (internationale) student, kan ik een studentenkaart kopen?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Ik ben student maar heb geen studentenkaart, kan ik toch een studententicket kopen?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Is het mogelijk om Nxt Museum te bezoeken met een ICOM/ Museumjaarkaart?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Waar kan ik mijn Stadspas ticket kopen?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Hoe kan ik Nxt Museum bezoeken met een IAmsterdam City Card?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Kan ik op de reservelijst worden gezet als tickets uitverkocht zijn?</summary>
                                <p className="HiddenText">
                                    Dit is helaas niet mogelijk.
                                </p>
                            </details>
                            <details>
                                <summary  >Hoe profiteer ik van dynamische ticketprijzen?</summary>
                                <p className="HiddenText">
                            ...
                            <details>
                                <summary  >Kan ik Nxt Museum (opnieuw) bezoeken met mijn Museumnacht ticket?</summary>
                                <p className="HiddenText">
                ...
                <div className="GroupBooking">
                    <details>
                        ...
                        <div className="Info">
                            ...
                            <details>
                                <summary  >Hoe regel ik een groepsbezoek aan Nxt Museum?</summary>
                            ...
                            <details>
                                <summary  >Welke workshops bieden jullie aan voor scholen?</summary>
                ...
                <div className="Accessibility">
                    <details>
                        ...
                        <div className="Info">
                            <details>
                                <summary  >Kan ik Nxt Museum bezoeken als ik epilepsie heb?</summary>
                            ...
                            <details>
                                <summary  >Is het museum rolstoeltoegankelijk?</summary>
                            ...
                            <details>
                                <summary  >Bieden jullie begeleiders tickets aan?</summary>
                            ...
                            <details>
                                <summary  >Parkeerplaatsen voor mindervaliden</summary>
                            ...
                            <details>
                                <summary  >Is het museum geschikt voor kinderen?</summary>
                            ...
                            <details>
                                <summary  >Vanaf welke leeftijd hebben kinderen zonder begeleiding toegang tot het museum?</summary>
                ...
                <div className="Museum">
                    <details>
                        <summary >In het museum</summary>
                        <p className="InfoMuseum">Alle meest gestelde vragen over het museum zelf</p>
                        <div className="Info">
                            <details>
                                <summary  >Hoe lang kan ik in het museum blijven?</summary>
                            ...
                            <details>
                                <summary  >Mag ik foto’s maken tijdens mijn bezoek?</summary>
                            ...
                            <details>
                                <summary  >Kan ik bij jullie gebruik maken van een kluisje?</summary>
                            ...
                            <details>
                                <summary  >Kan ik bij Nxt Museum gebruik maken van het wifi-netwerk?</summary>
                            ...
                            <details>
                                <summary  >Is eten en drinken toegestaan binnen de tentoonstelling?</summary>
                            ...
                            <details>
                                <summary  >Kan ik mijn hond meenemen naar Nxt Museum?</summary>
                            ...
                            <details>
                                <summary  >Wat is een POAP en hoe kan ik deze verzamelen in de tentoonstelling?</summary>
                ...
                <div className="Gifts">
                    <details>
                        <summary >Nxt Merchandise & Cadeautickets</summary>
                        <p className="GiftsInfo">Informatie over eventuele merchandise en/of cadeautickets</p>
                        <div className="Info">
                            <details>
                                <summary  >Is het mogelijk om voor meerdere tickets een cadeaubon aan te schaffen?</summary>
                            ...
                            <details>
                                <summary  >Hoe lang is mijn cadeauticket geldig?</summary>
                                <p className="HiddenText">Het cadeauticket is geldig tot 1 jaar na aankoop.</p>
                            </details>
                            <details>
                                <summary  >Kan ik een factuur ontvangen bij de aanschaf van een cadeauticket?</summary>
                ...
                <div className="Partnerships">
                    <details>
                        <summary >Partnerships & Pers</summary>
                        ...
                        <div className="Info">
                            <details>
                                <summary  >Ik werk voor een persorganisatie. Wie kan ik over samenwerkingen contacten?</summary>
                                <p className="HiddenText">Neem contact op via ons contact formulier.</p>
                            </details>
                            <details>
                                <summary  >Ik ben een kunstenaar / maker. Hoe kan ik het beste mijn project of voorstel indienen bij Nxt Museum?</summary>
